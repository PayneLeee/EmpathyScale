...
$coAssemblyMd = Join-Path $projectRoot "data\runs\2025-10-31_131000\empathy_scale_generation_agent_group\scale_draft.md"
$chatCollabMd = Join-Path $projectRoot "data\runs\2025-10-31_132506\empathy_scale_generation_agent_group\scale_draft.md"
...
if ($pythonAvailable) {
    try {
        ...
        $scriptPath = Join-Path $projectRoot "tools\convert_md_to_pdf.py"
        python $scriptPath
